<template>
  <q-dialog :modelValue="modelValue" persistent full-width @update:model-value="(e) => emit('update:modelValue', e)"
            @before-show="open"
  ...
  verdana: 'Verdana'
          ...
          <q-btn v-if="localNews.id" unelevated color="secondary" size="lg" class="full-width q-mt-md" label="Save News"
                 type="submit"
                 :disable="disable" />
          <q-btn v-else unelevated color="secondary" size="lg" class="full-width q-mt-md" label="Create News"
                 type="submit"
                 :disable="disable" />
